...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	memcached.SetConditionMemcached(metav1.Condition{Type: typeProgressingMemcached, Status: metav1.ConditionTrue, Reason: "Reconciling", Message: "Starting reconciliation"})
	...
	if isMemcachedMarkedToBeDeleted {
		if controllerutil.ContainsFinalizer(memcached, memcachedFinalizer) {
			...
			memcached.SetConditionMemcached(metav1.Condition{Type: typeDegradedMemcached,
	...
	if err != nil && apierrors.IsNotFound(err) {
		...
		if err != nil {
			...
			// The following implementation will update the status
			memcached.SetConditionMemcached(metav1.Condition{Type: typeAvailableMemcached,
	...
	if *found.Spec.Replicas != size {
		...
		if err != nil {
			...
			// The following implementation will update the status
			memcached.SetConditionMemcached(metav1.Condition{Type: typeDegradedMemcached,
				Status: metav1.ConditionTrue, Reason: "Resizing",
