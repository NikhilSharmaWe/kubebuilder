...
func main() {
	...
	if err = (&controllers.MemcachedReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("memcached-controller")}).SetupWithManager(mgr); err != nil {
	...
	if err = (&controllers.BusyboxReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("busybox-controller")}).SetupWithManager(mgr); err != nil {
