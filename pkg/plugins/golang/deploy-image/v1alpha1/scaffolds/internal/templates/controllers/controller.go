...
func (r *{{ .Resource.Kind }}Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	{{ lower .Resource.Kind }}.SetCondition{{ .Resource.Kind }}(metav1.Condition{Type: typeProgressing{{ .Resource.Kind }}, Status: "True",Reason: "Reconciling", Message: "Starting reconciliation"})
