...
func (r *{{ .Resource.Kind }}Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	meta.SetStatusCondition(&{{ lower .Resource.Kind }}.Status.Conditions, metav1.Condition{Type: typeProgressing{{ .Resource.Kind }}, Status: metav1.ConditionTrue, Reason: "Reconciling", Message: "Starting reconciliation"})
